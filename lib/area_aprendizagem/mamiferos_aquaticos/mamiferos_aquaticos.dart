...
class MamiferosAquaticos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const AppBarPadrao(titulo: 'Mamíferos aquáticos'),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // Imagem cachalote.
            const ImagemComZoom(
              urlImagem: 'assets/images/mamiferos_aquaticos/ma_cachalote.jpg',
              legenda: 'Cachalote',
              boxFit: BoxFit.fill,
            ),
            const Text.rich(
            ...
            // Imagem beluga.
            const ImagemComZoom(
              urlImagem: 'assets/images/mamiferos_aquaticos/ma_beluga.webp',
              legenda: 'Beluga',
            ),
            const Gap(10),
            const Text.rich(
              TextSpan(
                children: [
                  TextSpan(text: 'Ainda que este grupo seja amplamente '),
                  TextSpan(
                    style: TextStyle(color: Colors.blue),
